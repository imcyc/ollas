...
module.exports = function(app) {
    ...
    app.post('/api/todos', function(req, res) {
        Todo.create({
            ...
            tambor1uno: req.body.tambor1uno,
            tambor1dos: req.body.tambor1dos,
            tambor1tres: req.body.tambor1tres,
            tambor1cuatro: req.body.tambor1cuatro,
            tambor1cinco: req.body.tambor1cinco,
